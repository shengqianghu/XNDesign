...
<script>
	$(function() {
 	...
 	function addToCar(){
		...
		//get the size
		var size = $("select[name=choosenSize]").val();
		//get the quantity
		var quantity = $("select[name=quantity] ").val();
		/* $.post("shoppingcar_addToCar.action",{car.id:car_id,color_id:color,size_id:size,quantity:quantity},function(data){
			
		},"json")); */
		
		$.post("shoppingcar_addToCar.action",{"shoppingCar.car.id":car_id,"shoppingCar.carColor.id":color,"shoppingCar.carSize.id":size,"shoppingCar.quantity":quantity},function(data){
			if(data=="faile"){
			alert("You have been Logout ,Please To Login !!!");
			location.href="<%=path%>/login.jsp";
			}else{
				alert("Add To Car Successful !!!");
				$("#commodity_counts").html(data);
			}
		},"json");
	} 
</script>
			...
			<div class="main1">
				<div class="details">
					<div class="product-details">
						<div class="images_3_of_2">
							...
							<div class="desc span_3_of_2">
								<h2><s:property value="car.carKind.brand"></s:property>-<s:property value="car.brand"></s:property></h2>
								<p><s:property value="car.details"></s:property></p>
								 <s:hidden name="car.id"  id="car_id" ></s:hidden> 
								<div class="price">
									<p>
										Price: <span>$<s:property value="car.money"></s:property></span>
									</p>
								</div>
								<div class="available">
									...
									<ul>
										<li>Color: 
										<s:select list="car.colors" listKey="id" listValue="color" name="color"></s:select>
										</li>
										 <li>Size: <s:select list="car.sizes" listKey="id" listValue="size" name="choosenSize"></s:select>
										</li>
										<li>Quality: <select name="quantity">
												<option>1</option>
												<option>2</option>
												<option>3</option>
												<option>4</option>
								...
								<div class="share-desc">
									...
									<div class="button1">
										<span><a href="javascript:void(0)"  onclick="addToCar()"
											class="button button-rounded">Add to Cart</a></span>
									</div>
									<div class="clear"></div>
								</div>
								<div class="wish-list">
						...
						<div id="horizontalTab"
							...
							<ul class="resp-tabs-list">
								<li class="resp-tab-item resp-tab-active"
									aria-controls="tab_item-0" role="tab">Product Details</li>
								<li class="resp-tab-item" aria-controls="tab_item-1" role="tab">product
									Tags</li>
								<li class="resp-tab-item" aria-controls="tab_item-2" role="tab">Product
									Reviews</li>
								<div class="clear"></div>
							</ul>
							<div class="resp-tabs-container">
								<h2 class="resp-accordion resp-tab-active" role="tab"
									...
									<span class="resp-arrow"></span>Product Details
								</h2>
								<div
								...
								<div class="product-tags resp-tab-content"
								...
								<h2 class="resp-accordion" role="tab" aria-controls="tab_item-2">
									<span class="resp-arrow"></span>Product Reviews
								</h2>
								<div class="review resp-tab-content"
									...
									<div class="your-review">
										...
										<form>
											<div>
												<span> <label>Nickname<span class="red">*</span></label>
											...
											<div>
												<span> <label>Review<span class="red">*</span></label>
												</span> <span> <textarea> </textarea>
												</span>
											</div>
											<div>
												<span> <input type="submit" value="SUBMIT REVIEW">
												</span>
											</div>
										</form>
									</div>
					...
					<div class="content_bottom">
						...
						<div class="div2">
							<div id="mcts1">
								<img src="images/d_pic2.jpg" alt="" /> <img
									src="images/d_pic1.jpg" alt="" /> <img src="images/d_pic3.jpg"
									alt="" /> <img src="images/d_pic4.jpg" alt="" /> <img
									src="images/d_pic1.jpg" alt="" /> <img src="images/d_pic4.jpg"
									alt="" />
							</div>
						</div>
					</div>
